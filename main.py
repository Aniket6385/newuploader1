...
async def start(_,message):
  await message.reply_photo(
        ...
        caption=f"**𝙷𝚒! [{message.from_user.first_name}](tg://user?id={message.from_user.id})**\n\n"
                "**𝙶𝚒𝚟𝚎 /OwnerName ♌️ 𝙲𝚘𝚖𝚖𝚊𝚗𝚍 T𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙵𝚛𝚘𝚖 A 𝚃𝚎𝚡𝚝 F𝚒𝚕𝚎.**🎓✨",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("ᴄʜᴀɴɴᴇʟ", url="https://t.me/courses_terbot"),
                    InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/courses_terbot")
                ]
            ]
        )
    )
...
@bot.on_message(filters.command(["KHATAM"]))
async def account_login(bot: Client, m: Message):
    ...
    await m.reply_text("Done KHATAM♌️")
